 ...
 * // Actions
 * 
 * @FXML private void doAjouter() { modelCategorie.preparerAjouter();;
 * managerGui.showView( EnumView.CategorieForm ); }
 * 
 * @FXML private void doModifier() { modelCategorie.preparerModifier(
 * listView.getSelectionModel().getSelectedItem() ); managerGui.showView(
 * EnumView.CategorieForm ); }
 * 
 * @FXML private void doSupprimer() { if ( managerGui.showDialogConfirm(
 * "Confirmez-vous la suppresion ?" ) ) { modelCategorie.supprimer(
 ...
 * "Aucun élément n'est sélectionné dans la liste."); } else { doModifier(); } }
 * } }
 * 
 * 
