...
public class ControllerCoureurRechercher {
	...
	@FXML
	private ListView<Coureur>	listViewRecherche;
	...
	// Méthodes auxiliaires
		...
		private void selectionnerCoureur() {
			modelCoureur.viderListe();
			modelCoureur.getListe().add(listViewRecherche.getSelectionModel().getSelectedItem());
			modelCoureur.viderListetrie();
