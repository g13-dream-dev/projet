 ...
 * projet.view.EnumView; import projet.view.coureur.ModelCoureur;
 * 
 * 
 ...
 * 
 * @FXML private ListView<Coureur> listView;
 * 
 ...
 * modelPoste.actualiserListeClubs(); // Data binding listView.setItems(
 * modelPoste.getListe() );
 * 
 ...
 * }
 * 
 * public void refresh() { modelPoste.actualiserListeClubs();
 ...
 * modelPoste.actualiserListeCoureurs(listView.getSelectionModel().
 * getSelectedItem().getClub()); managerGui.showView( EnumView.CoureurForm ); }
 * } } }
 * 
 * 
 ...
 * buttonAjouter.setDisable(true); buttonImprimer.setDisable(true); } else {
 * buttonAjouter.setDisable(false); buttonImprimer.setDisable(false); } }
 * 
 * }
 */